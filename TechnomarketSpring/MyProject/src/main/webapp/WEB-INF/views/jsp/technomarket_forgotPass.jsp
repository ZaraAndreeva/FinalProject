 ...
 <%@ include file="/menu_nachalo.jsp" %>
    ...
    <div class="row-split">
        <div class="col-half">
            ...
            <form action = "http://localhost:8080/MyProject/forgotPass/forgotPass" method = "POST" class="fos_user_registration_register form-horizontal"><div class="form-group"><label  class="col-sm-6 control-label required" for="fos_user_registration_form_first_name">
                     E-mail
